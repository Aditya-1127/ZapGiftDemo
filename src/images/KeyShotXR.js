...
window.keyshotXR = function (X, w, G, Y, va, D, wa, xa, ya, za, Aa, K, L, Z, $, Ba, aa, Ca, ba, Da, ca, Ea, Fa, Ga, Ha, r, Ia) {
	...
	this.Wa = function () {
		a.v(!a.l);
		a.l ? a.H.setAttribute("src", A + a.s + "/files/GoFullScreenIcon.png") : a.H.setAttribute("src",
	...
	this.Sa = function (b) {
		if (a.p) {
			...
			b = "";
			if (a.o.$) var d = a.o.$,
				b = b + ("translate(" + d.Na + "px," + d.Oa + "px) rotate(" + d.ka + "deg) scale(" + d.Pa + "," + d.Qa + ") ");
	...
	if (document.createElement("canvas").getContext) {
		...
		if (a.W) {
			...
			J ? a.X.setAttribute("src", A + a.s + "/files/xr_hand.gif") : a.X.setAttribute("src",
				A + a.s + "/files/xr_cursor.gif");
